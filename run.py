...
class Run():
    def __init__(self,
        ...
        self.src_path = self.input_root + '/train_src.csv'  # '/train_src.csv'
        self.tgt_path = self.input_root + '/train_tgt.csv'  # '/train_tgt.csv'
        self.meta_path = self.input_root + '/train_meta.csv'  # '/train_meta.csv'
        self.test_path = self.input_root + '/test.csv'  # '/test.csv'
