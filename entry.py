...
def prepare(config_path):
    ...
    parser.add_argument('--task', default='3')  # Book -> Music
    # parser.add_argument('--base_model', default='MF')
    parser.add_argument('--base_model', default='DNN')
    parser.add_argument('--seed', type=int, default=2020)
    parser.add_argument('--ratio', default=[0.2, 0.8])  # [0.8, 0.2]
...
if __name__ == '__main__':
    ...
    if args.process_data_mid:
        ...
        for dealing in ['book', 'movie', 'music']:  # with Douban data
